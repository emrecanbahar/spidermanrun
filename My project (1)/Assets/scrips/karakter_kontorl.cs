...
public class karakter_kontorl : MonoBehaviour
{
    Rigidbody rigi;
    ...
    void Start()
    {
        ...
        yonet = GameObject.Find("yönetici").GetComponent<yönetici>();
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            yol_2.position = new Vector3(yol_2.position.x, yol_2.position.y, yol_1.position.z + 28.0f);
        }
        if (other.gameObject.name == "yol_2")
        {
            yol_1.position = new Vector3(yol_1.position.x, yol_1.position.y, yol_2.position.z + 28.0f);
        }
    ...
    void Update()
    {
        ...
        if (sag == true)
        {
            transform.position = Vector3.Lerp(transform.position, new Vector3(7.0f, transform.position.y, transform.position.z), kosma_hizi * Time.deltaTime);
        }


        if (sol == true)
        {
            transform.position = Vector3.Lerp(transform.position, new Vector3(-3.30f, transform.position.y, transform.position.z), kosma_hizi * Time.deltaTime);
